...
class OPTEEGateKeeperDevice {
    public:

    explicit OPTEEGateKeeperDevice(const hw_module_t* module);
...
// JBECH: Trusty functions
    ...
    // Static methods interfacing the HAL API with the OPTEEGateKeeper device
